...
//		virtual bool FunctionShadedFill(GfxState *pGState, GfxFunctionShading *pShading) override;
//		virtual bool AxialShadedFill(GfxState *pGState, GfxAxialShading    *pShading) override;
//		virtual bool RadialShadedFill(GfxState *pGState, GfxRadialShading   *pShading) override;
//		virtual bool GouraundTriangleFill(GfxState *pGState, const std::vector<GfxColor*> &colors, const std::vector<NSStructures::Point> &points) override;
//		virtual bool PatchMeshFill(GfxState *pGState, GfxPatch* pPatch) override;
	...
	private:
		...
		//GrClip                       *m_pClip;       // now in GfxState
		bool                          m_bTiling;
