...
//------------------------------------------------------------------------
    ...
    public:
        ...
        Dict *getResDict() { return resDict.isDict() ? resDict.getDict() : (Dict *) NULL; }
...
//------------------------------------------------------------------------
    ...
    public:
        ...
        // Copy.
        GfxPath *copy() { return new GfxPath(justMoved, firstX, firstY, subpaths, n, size); }
...
//------------------------------------------------------------------------
    ...
    public:
        ...
        // Copy.
        GfxState *copy(GBool copyPath = gFalse) { return new GfxState(this, copyPath); }
        ...
        void getFillGray(GfxGray *gray) { fillColorSpace->getGray(&fillColor, gray, renderingIntent); }

        void getStrokeGray(GfxGray *gray) { strokeColorSpace->getGray(&strokeColor, gray, renderingIntent); }

        void getFillRGB(GfxRGB *rgb) { fillColorSpace->getRGB(&fillColor, rgb, renderingIntent); }

        void getStrokeRGB(GfxRGB *rgb) { strokeColorSpace->getRGB(&strokeColor, rgb, renderingIntent); }

        void getFillCMYK(GfxCMYK *cmyk) { fillColorSpace->getCMYK(&fillColor, cmyk, renderingIntent); }

        void getStrokeCMYK(GfxCMYK *cmyk) { strokeColorSpace->getCMYK(&strokeColor, cmyk, renderingIntent); }
        ...
        void curveTo(double x1, double y1, double x2, double y2,
                     double x3, double y3) { path->curveTo(x1, y1, x2, y2, curX = x3, curY = y3); }
